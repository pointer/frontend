...
function generate_cutomPDF() {
  ...
  // var w = doc.getStringUnitWidth('GSTIN') * NormalFontSize;
  doc.textAlign(
    customer_BillingInfoJSON.CustomerGSTIN,
    { align: 'left' },
    80,
    startY
  )
  ...
  doc.setFontType('normal')
  doc.textAlign(
    customer_BillingInfoJSON.CustomerState,
    { align: 'left' },
    80,
    startY
  )
  ...
  doc.setFontType('normal')
  doc.textAlign(
    customer_BillingInfoJSON.CustomerEmail,
    { align: 'left' },
    80,
    startY
  )
  ...
  doc.setFontType('normal')
  doc.textAlign(
    customer_BillingInfoJSON.CustomerPhno,
    { align: 'left' },
    80,
    startY
  )
...
function generate_cutomPDF_landscape() {
  ...
  const rightStartCol1 = doc.internal.pageSize.width - 195
  const rightStartCol2 = doc.internal.pageSize.width - 115
  ...
  doc.setLineWidth(1)
  const lineEnd1 = doc.internal.pageSize.width / 2 - 70
  const lineEnd2 = doc.internal.pageSize.width - 10
  // doc.line(20, startY+lineSpacing.NormalSpacing, 580, startY+=lineSpacing.NormalSpacing);
  doc.line(
    20,
    startY + lineSpacing.NormalSpacing,
